...
class SharedDataMiddleware:
    ...
    """A WSGI middleware which provides templates content for development
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/templates': ('myapplication', 'templates')
        })

    This will then serve the ``templates`` folder in the `myapplication`
    Python package.
    ...
    only file names for templates files.
